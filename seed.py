...
def seed():
    with app.app_context():
        ...
        # ── Users ──────────────────────────────────────────────────────────
        admin = User(name="Admin User",       email="admin@hs.com",role="Admin",    phone="+234 800 000 0001")
        admin.set_password("admin123")
        lord  = User(name="Mr. Hassan Sani",  email="landlord@hs.com",role="Landlord", phone="+234 800 000 0002")
        lord.set_password("land123")
        t1    = User(name="Adebayo Okafor",   email="tenant@hs.com",role="Tenant",   phone="+234 801 234 5678")
        t1.set_password("tenant123")
        t2    = User(name="Chioma Eze",       email="c.eze@gmail.com",role="Tenant",   phone="+234 803 456 7890")
        t2.set_password("tenant123")
        t3    = User(name="Marcus Johnson",   email="m.johnson@corp.com",role="Tenant",   phone="+234 805 678 9012")
        t3.set_password("tenant123")
        t4    = User(name="Fatima Al-Hassan", email="f.alhassan@nbn.gov",role="Tenant",   phone="+234 809 012 3456")
        t4.set_password("tenant123")
        t5    = User(name="David Nwachukwu",  email="d.nwachukwu@gmail.com",role="Tenant",phone="+234 811 234 5678")
        t5.set_password("tenant123")
